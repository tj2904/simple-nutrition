...
export default function SearchIndex() {
  ...
  return (
    <div className=" pt-14 min-h-full mt-8">
      <div className="w-screen flex flex-col justify-center items-center">
        ...
        <div className="text-center max-w-screen-lg mb-10">
          <h1 className="font-bold text-2xl">Dish creation</h1>
          <p className="text-stone-400 m-5">
            Search for multiple ingredients and save a dish with them, for
            future search. <br />
            This allows for easy tracking of your favourite dishes, and looking
            up the Nutritional content of all meals consumed in a single search.
          </p>
